...
- Added an explicit review distinction: hand-written curated records show `OUR STAFF'S REVIEW`, while live-only seeded records show `WHY THIS FITS` so the app does not imply the store has written 110 full reviews.
